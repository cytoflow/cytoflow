...
# if we're on Windows, collect the ANGLE deps
# https://github.com/cytoflow/cytoflow/issues/298

if is_win:
    from PyInstaller.utils.hooks import conda_support
    dlls = conda_support.collect_dynamic_libs('qt')

    binaries = [x for x in dlls if 'libEGL' in x[0] 
                                or 'libGLESv2' in x[0]
                                or 'opengl32sw' in x[0]]
