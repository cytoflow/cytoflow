...
MOCK_MODULES = ['cytoflow.utility.logicle_ext', 'cytoflow.utility.logicle_ext.Logicle', 'cytoflow.utility.logicle_ext.Logicle.Logicle', 'bottleneck']
