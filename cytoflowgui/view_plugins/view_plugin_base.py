...
base_plot_params_view = View( Item('title',
...
data_plot_params_view =  View(Item('min_quantile',
                                   editor = TextEditor(auto_set = False)),
                              Item('max_quantile',
                                   editor = TextEditor(auto_set = False)),
                              base_plot_params_view.content)


data_1d_plot_params_view =  View(Item('orientation'),
                                 Item('lim',
                                      label = "Data\nLimits",
                                      editor = TupleEditor(editors = [TextEditor(auto_set = False,
                                                           ...
                                                           labels = ["Min", "Max"],
                                                           cols = 1)),
                                 data_plot_params_view.content)


data_2d_plot_params_view =  View(Item('xlim',
                                      label = "X Limits",
                                      editor = TupleEditor(editors = [TextEditor(auto_set = False,
                                                                                 evaluate = float,
                                                                                 format_func = lambda x: "" if x == None else str(x)),
...
stats_1d_plot_params = View(Item('orientation'),
                            Item('lim',
                                 label = "Limits",
                                 editor = TupleEditor(editors = [TextEditor(auto_set = False,
                                                                            evaluate = float,
...
stats_2d_plot_params = View(Item('xlim',
                                 label = "X Limits",
                                 editor = TupleEditor(editors = [TextEditor(auto_set = False,
                                                                            evaluate = float,
                                                                            format_func = lambda x: "" if x == None else str(x)),
