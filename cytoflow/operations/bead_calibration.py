...
class BeadCalibrationOp(HasStrictTraits):
    ...
    BEADS = \
    {
        ...
        'URQP-38-6K': {
            'ERF FITC': [8020.0, 71000.0, 209000.0, 499000.0, 1030000.0],
            'ERF NILE RED': [64900.0, 653000.0, 1710000.0, 4410000.0, 8930000.0],
            'ERF C30': [52400.0, 323000.0, 995000.0, 3830000.0, 7170000.0],
            'ERF APC': [1110.0, 6480.0, 18000.0, 73300.0, 331000.0]
        },
        'URPC-100-2H': {
            'MEFL': [
                4648.0, 14631.0, 42313.0, 128924.0, 381106.0, 1006897.0, 2957538.0,
                7435549.0
            ],
            'MEPE': [
                2800.0, 8770.0, 25174.0, 74335.0, 219816.0, 548646.0, 1600005.0,
                4255375.0
            ],
            'MEPTR': [
                17518.0, 53950.0, 153641.0, 450901.0, 1283877.0, 3254513.0,
                9431807.0, 24840372.0
            ],
            'MEPerCP': [
                4354.0, 10032.0, 22473.0, 51739.0, 115599.0, 256091.0, 562684.0,
                1201350.0
            ],
            'MEPerCPCy5.5': [
                2088.0, 6705.0, 20441.0, 66215.0, 211174.0, 645020.0, 2478405.0,
                10603147.0
            ],
            'MEeF710': [
                2259.0, 6862.0, 20129.0, 63316.0, 196680.0, 609247.0, 2451473.0,
                11687960.0
            ],
            'MEPCY7 (B)': [
                534.0, 1555.0, 4600.0, 14826.0, 47575.0, 161926.0, 706536.0,
                3262715.0
            ],
            'MEPCY5': [
                4354.0, 10032.0, 22473.0, 51739.0, 115599.0, 256091.0, 562684.0,
            ...
            'MEPCY5.5': [
                1999.0, 6228.0, 20393.0, 69124.0, 220232.0, 777840.0, 2521966.0,
                8948283.0
            ],
            'MEAX700': [
                6625.0, 17113.0, 58590.0, 199825.0, 629666.0, 2289301.0, 6504723.0,
                17637305.0
            ],
            'MEPCY7 (Y)': [
                457.0, 1334.0, 4666.0, 17500.0, 58774.0, 230324.0, 724800.0,
                2057002.0
            ],
            'MEAPC': [
                1170.0, 1970.0, 4669.0, 13757.0, 36757.0, 119744.0, 293242.0,
                638909.0
            ],
            'MEAX680': [
                6844.0, 17166.0, 56676.0, 195246.0, 622426.0, 2333985.0, 6617776.0,
                17561028.0
            ],
            'MEAPCCY7': [
                1385.0, 3804.0, 13066.0, 47512.0, 151404.0, 542987.0, 1305924.0,
                2540123.0
            ],
            'MEPacBlue': [
                4450.0, 8342.0, 17587.0, 38906.0, 89281.0, 179989.0, 408481.0,
                822214.0
            ],
            'MEAMCY': [
                5974.0, 10513.0, 21623.0, 46727.0, 105630.0, 213273.0, 494395.0,
                1072308.0
            ],
            'MEPO':
            [391.0, 753.0, 1797.0, 4766.0, 13937.0, 39280.0, 156244.0, 652221.0],
            'MEQ605': [
                3133.0, 4774.0, 8471.0, 16359.0, 34465.0, 71375.0, 189535.0,
                517591.0
            ],
            'MEQ655': [
                1859.0, 2858.0, 5598.0, 11928.0, 27542.0, 66084.0, 202508.0,
                650000.0
            ],
            'MEQ705': [
                1695.0, 2858.0, 5598.0, 11928.0, 27542.0, 66084.0, 202508.0,
                650000.0
            ],
            'MEBV711': [
                1564.0, 3234.0, 5516.0, 12249.0, 29651.0, 71051.0, 197915.0,
                596714.0
            ],
            'MEQ800': [
                1358.0, 2085.0, 4301.0, 10037.0, 23446.0, 64511.0, 186279.0,
                644779.0
            ]
    }
}
    ...
    - Spherotech URPQ-38-6K
    - Spherotech URPC-100-2H
    ...
    (There are obviously others in use -- if you need these configurations, contact Spherotech directly.)
    """
